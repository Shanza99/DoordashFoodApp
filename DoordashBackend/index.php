    ...
    <div class="wide-container">
        ...
        <div class="nav-header">
            ...
            <div class="nav-links">
                ...
                <a href="merchant_register.php" class="nav-link">Become A Merchant</a>
                <a href="delivery_register.php" class="nav-link">Become A Dasher</a>
<a href="customer_register.php" class="nav-link">Become a Customer</a>
        ...
        <div class="content">
            ...
            <!-- Continue Button - ALWAYS PRESENT WITH CONSISTENT ID -->
            ...
            <?php else: ?>
                <div class="user-actions">
                    ...
                    <?php if($_SESSION['user_type'] === 'restaurant'): ?>
                        <a href="restaurant_dashboard.php" class="admin-panel-btn">
                            <i class="fas fa-store"></i> Restaurant Dashboard
                        </a>
                    <?php endif; ?>
                    <?php if($_SESSION['user_type'] === 'delivery'): ?>
                        <a href="delivery_dashboard.php" class="admin-panel-btn">
    ...
    <script>
        ...
        // Continue Button Event Listener - ALWAYS PRESENT
        continueBtn?.addEventListener('click', function() {
            ...
            if (address) {
                console.log('Processing address for user type:', currentUser?.user_type);
                
                // Show loading state
                setLoading('continue-btn', true);
                
                // Handle different user types
                if (currentUser) {
                    switch(currentUser.user_type) {
                        case 'customer':
                            // Save address and search restaurants
                            const formData = new FormData();
                            formData.append('action', 'save_address');
                            ...
                            .then(data => {
                                ...
                                window.location.href = `restaurants.php?search=${encodeURIComponent(address)}&location_search=true`;
                            })
                            .catch(error => {
                        ...
                        case 'delivery':
                            ...
                            window.location.href = 'delivery_dashboard.php';
                            break;
                    ...
                    // For non-logged in users, always search restaurants
                    window.location.href = `restaurants.php?search=${encodeURIComponent(address)}&location_search=true`;
                }
            } else {
                ...
                if (currentUser) {
                    switch(currentUser.user_type) {
                        ...
                        default:
                            Toast.fire({
                                icon: 'error',
                                title: 'Please enter a delivery address to find restaurants'
                            });
                            addressInput?.focus();
                    }
                } else {
        ...
        // Event listeners for address input
                    ...
                    if (buttonId === 'continue-btn') {
                        if (currentUser) {
                            if (currentUser.user_type === 'customer') {
                                button.innerHTML = '<i class="fas fa-utensils"></i> Find Restaurants Near You';
                            } else if (currentUser.user_type === 'restaurant') {
                                button.innerHTML = '<i class="fas fa-store"></i> Manage Your Restaurant';
                            } else {
                                button.innerHTML = '<i class="fas fa-motorcycle"></i> Find Delivery Opportunities';
                            }
                        } else {
                            button.innerHTML = '<i class="fas fa-utensils"></i> Find Restaurants Near You';
                        }
        ...
        // Initialize
        console.log('🍕 DoorDash App Loaded!');
        console.log('Current User:', currentUser);
